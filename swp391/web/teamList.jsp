                    ...
                    <div class="topic__filter">
                        ...
                        <div class="dropdown1">
                            <ul class="filter__list">
                                <li class="filter__item" name="filter"><a href="${root}/group/filter.do?filter=Quan tri kinh doanh">Quan tri kinh doanh</a></li>
                                <li class="filter__item" name="filter"><a href="${root}/group/filter.do?filter=Cong nghe thong tin">Cong nghe thong tin</a></li>
                                <li class="filter__item" name="filter"><a href="${root}/group/filter.do?filter=Ngon ngu Anh">Ngon ngu Anh</a></li>
                                <li class="filter__item" name="filter"><a href="${root}/group/filter.do?filter=Ngon ngu Han Quoc">Ngon ngu Han Quoc</a></li>
                                <li class="filter__item" name="filter"><a href="${root}/group/filter.do?filter=Ngon ngu Nhat">Ngon ngu Nhat</a></li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <c:if test="${list.leaderStatus == 1}">
                                <tbody>
                                    <tr>
                                        ...
                                        <td><span class="tdTbl__warning">${list.proStatus.status==1?"unlocked":"locked"}</span></td>
